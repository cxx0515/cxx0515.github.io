...
<button id="btn-ywcy-2" style="border: none;">公司外部</button>
     ...
     <div class="row "> 
       <div class="url-card col-6 col-sm-6 col-md-4 col-xl-5a col-xxl-7a" data-category="btn-ywcy-1">
        ...
        <div class="url-card col-6 col-sm-6 col-md-4 col-xl-5a col-xxl-7a" data-category="btn-ywcy-1">
            <div class="url-body default">
                <a href="https://oa.dlsteelgroup.com/" target="_blank" data-id="202" class="card no-c mb-4 site-725" data-toggle="tooltip" data-placement="bottom" title="集团OA">
                    <div class="card-body">
                        <div class="url-content d-flex align-items-center">
                            <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center">
            ...
            <div class="url-body default">
                <a href="https://www.delongzc.com/dljt/j_form" target="_blank"  data-id="202" class="card no-c mb-4 site-725" data-toggle="tooltip" data-placement="bottom" title="上海德龙钢铁集团-数智招采平台">
                    <div class="card-body">
                        <div class="url-content d-flex align-items-center">
                            <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center">
                                <img src="ico/zonghewuliu.png" />
                            </div>
                            <div class="url-info flex-fill">
                                <div class="text-sm overflowClip_1">
                                    <strong>数智招采平台</strong>
                                </div>
                                <p class="overflowClip_1 m-0 text-muted text-xs">上海德龙钢铁集团</p>
                            </div>
                        </div>
                    </div>
                </a>
      ...
      <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ywcy-1"> 
       <div class="url-body default"> 
        <a href="http://169.85.160.56/iEAM/Index" target="_blank" data-id="228" class="card no-c  mb-4 site-693" data-toggle="tooltip" data-placement="bottom" title="天铁设备管理系统"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center"> 
            <img src="ico/ttsbgl.png" /> 
           </div> 
           <div class="url-info flex-fill"> 
            <div class="text-sm overflowClip_1"> 
             <strong>天铁设备管理系统</strong> 
            </div> 
            <p class="overflowClip_1 m-0 text-muted text-xs">天铁设备管理系统</p> 
           </div> 
          </div> 
         </div> </a> 
       </div> 
      ...
      <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ywcy-1"> 
       <div class="url-body default"> 
        <a href="http://dxdc.dexin-steel.com/" target="_blank" data-id="228" class="card no-c  mb-4 site-693" data-toggle="tooltip" data-placement="bottom" title="德信一卡通"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center"> 
            <img src="ico/dxykt.png" /> 
           </div> 
           <div class="url-info flex-fill"> 
            <div class="text-sm overflowClip_1"> 
             <strong>德信点餐系统</strong> 
            </div> 
            <p class="overflowClip_1 m-0 text-muted text-xs">德信一卡通</p> 
           </div> 
          </div> 
         </div> </a> 
       </div> 
      ...
      <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ywcy-1"> 
       <div class="url-body default"> 
        <a href="http://157.10.0.32" target="_blank" data-id="228" class="card no-c  mb-4 site-693" data-toggle="tooltip" data-placement="bottom" title="青山一卡通"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center"> 
            <img src="ico/qsykt.png" /> 
           </div> 
           <div class="url-info flex-fill"> 
            <div class="text-sm overflowClip_1"> 
             <strong>青山点餐系统</strong> 
            </div> 
            <p class="overflowClip_1 m-0 text-muted text-xs">青山一卡通</p> 
           </div> 
          </div> 
         </div> </a> 
       </div> 
	  ...
	  <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ywcy-1"> 
       <div class="url-body default"> 
        <a href="http://16.16.1.47:5004/" target="_blank" data-id="228" class="card no-c  mb-4 site-693" data-toggle="tooltip" data-placement="bottom" title="德信检斤系统"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center"> 
           ...
           <div class="url-info flex-fill"> 
            <div class="text-sm overflowClip_1"> 
             <strong>德信检斤管理系统</strong> 
            </div> 
            <p class="overflowClip_1 m-0 text-muted text-xs">德信检斤</p> 
           </div> 
          </div> 
         </div> </a> 
       </div> 
      ...
      <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ywcy-1"> 
       <div class="url-body default"> 
        <a href="http://16.16.1.46/" target="_blank" data-id="228" class="card no-c  mb-4 site-693" data-toggle="tooltip" data-placement="bottom" title="德信-网址导航"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center"> 
            <img src="ico/dexin.png" /> 
           ...
           <div class="url-info flex-fill"> 
            <div class="text-sm overflowClip_1"> 
             <strong>德信-网址导航</strong> 
            </div> 
            <p class="overflowClip_1 m-0 text-muted text-xs">德信-网址导航</p> 
           </div> 
          </div> 
         </div> </a> 
       </div> 
	   ...
	   <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ywcy-1"> 
       <div class="url-body default"> 
        <a href="http://16.16.6.24/index" target="_blank" data-id="228" class="card no-c  mb-4 site-693" data-toggle="tooltip" data-placement="bottom" title="德信综合物流平台1.0"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center"> 
            <img src="ico/zonghewuliu.png" /> 
	  ...
	  <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ywcy-1"> 
       <div class="url-body default"> 
        <a href="https://mlt.etsingshan.com/mobile-nav/m" target="_blank" data-id="228" class="card no-c  mb-4 site-693" data-toggle="tooltip" data-placement="bottom" title="IMIP园区导航"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           ...
           <div class="url-info flex-fill"> 
            <div class="text-sm overflowClip_1"> 
             <strong>IMIP园区导航</strong> 
            </div> 
            <p class="overflowClip_1 m-0 text-muted text-xs">园区导航</p> 
           </div> 
          </div> 
         </div> </a> 
       </div> 
	    ...
	    <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ywcy-1"> 
       <div class="url-body default"> 
        <a href="ttp://16.16.6.19" target="_blank" data-id="228" class="card no-c  mb-4 site-693" data-toggle="tooltip" data-placement="bottom" title="德信智能管控平台"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center"> 
            <img src="ico/dxaq.ico" /> 
           </div> 
           <div class="url-info flex-fill"> 
            <div class="text-sm overflowClip_1"> 
 ...
 <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ystj-1"> 
       <div class="url-body default"> 
        <a href="https://www.ncat21.com/" target="_blank" data-id="4108" class="card no-c  mb-4 site-360" data-toggle="tooltip" data-placement="bottom" title="网飞猫,网飞猫APP,TV,盒子,恐怖电影,奈飞Netflix,2025最新电影,在线电影网,免费VIP视频,日本动,韩国电影,日本电影,免费视频,在线视频,预告片"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center"> 
            <img src="ico/wfm.png" /> 
           ...
           <div class="url-info flex-fill"> 
            ...
            <p class="overflowClip_1 m-0 text-muted text-xs">免费在线观看</p> 
           </div> 
          </div> 
         </div> </a> 
       </div> 
      ...
      <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ystj-1"> 
       <div class="url-body default"> 
        <a href="https://libviogroup.github.io/" target="_blank" data-id="4102" class="card no-c  mb-4 site-725" data-toggle="tooltip" data-placement="bottom" title="超清在线视频"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center"> 
      ...
      <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   " data-category="btn-ystj-1"> 
       <div class="url-body default"> 
        <a href="https://555dy.tv/" target="_blank" data-id="4108" class="card no-c  mb-4 site-360" data-toggle="tooltip" data-placement="bottom" title="在线播放最新热门电影,独播点播电视剧"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-img rounded-circle mr-2 d-flex align-items-center justify-content-center"> 
