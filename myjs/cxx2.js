document.addEventListener("DOMContentLoaded", function() {
    ...
    const businessSection = `
     ...
     <div class="row "> 
      ...
      <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   "> 
       <div class="url-body default"> 
        <a href="http://wcjs.sbj.cnipa.gov.cn/" target="_blank" data-id="220" class="card no-c  mb-4 site-12" data-toggle="tooltip" data-placement="bottom" title="中国商标网"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-info flex-fill"> 
            <div class="text-sm overflowClip_1"> 
     ...
     <div class="row "> 
      ...
      <div class="url-card col-6  col-sm-6 col-md-4 col-xl-5a col-xxl-7a   "> 
       <div class="url-body default"> 
        <a href="https://555dyy.top/" target="_blank" data-id="4108" class="card no-c  mb-4 site-360" data-toggle="tooltip" data-placement="bottom" title="在线播放最新热门电影,独播点播电视剧"> 
         <div class="card-body"> 
          <div class="url-content d-flex align-items-center"> 
           <div class="url-info flex-fill"> 
            <div class="text-sm overflowClip_1"> 
